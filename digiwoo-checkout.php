        ...
        <div class="fast-checkout-cart">
	        ...
	        <div class="product-category-section" style="margin-top:10px; margin-bottom:30px;">
	            ...
	            foreach ($product_categories as $category) {
	            		...
	            		echo '<div class="w-100 btn btn-outline-success py-3 my-3 rounded mx-1 fast-checkout-radio-select fast-checkout-radio-select-category fast-checkout-border-style-1 fast-checkout-title-category text-left">';
